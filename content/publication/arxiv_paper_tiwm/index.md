...
summary: We introduce the Tokenized Intent World Model (TIWM), a paradigm shift that challenges the necessity of high-fidelity world reconstruction. By formalizing Tokens as functional neural cell assemblies, our agent demonstrates emergent cognitive behaviors and strong closed-loop performance (score 59) on the NuPlan Mini-split benchmark. This is achieved using only 1% of the training data typically required by large-scale models. This work validates the feasibility of sparse, intent-driven cognitive alignment, reconciling the dichotomy between Symbolism and Connectionism with unprecedented data efficiency.
